...
class EnumerateStableMatchings:
    ...
    def choose(self, i):
        ...
        if i > self.students:
            ...
            if self.blockingpair:
                ...
                #print("-"*50)
                # print(self.M) each stable matchings can be displayed by uncommenting this print line
                # we append the stable matchings to a list -- copy first to avoid reference issue              
                self.stable_matchings.append(self.M.copy())
